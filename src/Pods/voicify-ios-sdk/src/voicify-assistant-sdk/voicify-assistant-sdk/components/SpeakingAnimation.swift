...
public struct SpeakingAnimation: View {
    ...
    public init(isSpeaking: Binding<Bool>, isFullScreen: Binding<Bool>, animationValues: Binding<Array<CGFloat>>, equalizerColor: String? = nil) {
    ...
    public var body: some View {
        HStack{
            ...
            .background(Color.init(hex: equalizerColor ?? "#00000080"))
